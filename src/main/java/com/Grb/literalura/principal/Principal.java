package com.Grb.literalura.principal;

import com.Grb.literalura.modelos.Autor;
import com.Grb.literalura.modelos.Libro;
import com.Grb.literalura.modelos.dto.DatosAutor;
import com.Grb.literalura.modelos.dto.DatosLibros;
import com.Grb.literalura.modelos.dto.DatosResponse;
import com.Grb.literalura.repository.AutorRepository;
import com.Grb.literalura.repository.LibroRepository;
import com.Grb.literalura.service.ConvierteDatos;
import com.Grb.literalura.service.ServiceConsultaApi;
...
public class Principal {
    ...
    private void verAutoresEnAnnoN() {
        System.out.println("Ingresa el año de vivo de autor(es) que desea buscar");


        System.out.print(commandLinner);
        int anio = teclado.nextInt();
        var autores = autorRepository.encontrarAutoresEntreFechas(anio);
        if (autores.isEmpty()) {
